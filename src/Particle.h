...
public:
	...
	void load(float x1, float y1, float z1);
	void rebirth(float t, float x1, float y1, float z1);
	void update(float t, float h, const glm::vec3 &g, const bool *keyToggles, float x1, float y1, float z1);
